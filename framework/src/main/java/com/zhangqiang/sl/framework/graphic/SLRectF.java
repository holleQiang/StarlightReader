...
public class SLRectF {
     ...
     */
    public SLRectF(float left, float top, float right, float bottom) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
     ...
     *              rectangle
     */
    public boolean contains(SLRectF r) {
        // check for empty first
        return this.left < this.right && this.top < this.bottom
                // now check for containment
     ...
     *              return false and do not change this rectangle.
     */
    public boolean intersect(SLRectF r) {
     ...
     */
    public boolean setIntersect(SLRectF a, SLRectF b) {
     ...
     */
    public static boolean intersects(SLRectF a, SLRectF b) {
     ...
     */
    public void roundOut(SLRectF dst) {
